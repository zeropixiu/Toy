		...
		<div id="content">
			...
			%>
				<tr class="result">
					<td><%=user.getName() %></td>
					<td>
						<a href="${pageContext.request.contextPath }/CustomerServlet?m=showDetail&cid=<%=user.getId() %>">查看</a>
						<a href="${pageContext.request.contextPath }/CustomerServlet?m=toUpdate&cid=<%=user.getId() %>">更新</a>
						<a href="${pageContext.request.contextPath }/CustomerServlet?m=delete&cid=<%=user.getId() %>" onclick="return del_confirm();">删除</a>
					</td>
